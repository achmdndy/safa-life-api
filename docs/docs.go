...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/prayertimes.PrayerTimesSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
                        "schema": {
                            "$ref": "#/definitions/prayertimes.PrayerTimesErrorResponse"
                        }
                    },
                    "500": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/prayertimes.PrayerTimesListSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
    ...
    "definitions": {
        ...
        "dto.PrayerTimesListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PrayerTimesResponse"
                    }
                }
            }
        },
        "dto.PrayerTimesResponse": {
            "type": "object",
            "properties": {
                "asr": {
                    "type": "string"
        ...
        "prayertimes.PrayerTimesErrorResponse": {
            "type": "object",
            "properties": {
                "errors": {
        ...
        "prayertimes.PrayerTimesListSuccessResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.PrayerTimesListResponse"
                },
                "message": {
                    "type": "string",
                    "example": "Prayer times list retrieved successfully"
                },
                "responseTime": {
                    "type": "string",
                    "example": "15.234ms"
        ...
        "prayertimes.PrayerTimesSuccessResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.PrayerTimesResponse"
                ...
                "message": {
                    "type": "string",
                    "example": "Prayer times retrieved successfully"
                },
                "responseTime": {
                    "type": "string",
                    "example": "15.234ms"
    ...
    "tags": [
        ...
        {
            "description": "Operations for managing and retrieving Quran recitations (audio) from various reciters.",
            "name": "Audio"
        },
        {
            "description": "Operations related to managing user bookmarks for Quran verses (add, retrieve, update, delete).",
            "name": "Bookmarks"
        },
        {
            "description": "Operations for saving and retrieving the user's last read verse or surah in the Quran.",
            "name": "LastRead"
        },
        {
            "description": "Operations for tracking and managing user progress in completing Quran reading (Khatam progress).",
            "name": "ProgressHatam"
        },
        {
            "description": "Operations for managing and retrieving information about Quran reciters and their available audio sets.",
            "name": "Reciters"
        },
        {
            "description": "Operations for managing and retrieving Quran verse translations in various languages.",
            "name": "Translations"
        },
        {
            "description": "Operations for retrieving and managing daily prayer times based on geographic coordinates and calculation methods.",
            "name": "PrayerTimes"
        }
    ],
    "externalDocs": {
