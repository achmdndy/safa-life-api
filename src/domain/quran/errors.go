...
var (
	...
	// Translation edition errors
	ErrTranslationEditionNotFound      = errors.New("translation edition not found")
	ErrTranslationEditionAlreadyExists = errors.New("translation edition already exists")
	ErrInvalidLanguage                 = errors.New("invalid language code")

	// Ayah translation errors
	ErrAyahTranslationNotFound      = errors.New("ayah translation not found")
	ErrAyahTranslationAlreadyExists = errors.New("ayah translation already exists")

	// Reciter errors
	ErrReciterNotFound      = errors.New("reciter not found")
	ErrReciterAlreadyExists = errors.New("reciter already exists")

	// Ayah audio file errors
